    ...
    public partial class Form2 : Form
    {
        ...
        public void timer1_Tick_1(object sender, EventArgs e)
        {
            ...
            if (this.czy_pierwsza > 1)
            {
                ...
                {
                    timer1.Stop();
                    licznik1 = licznik_dobrych_ruchow / 10 * 100;
                    czas1 = this.sredni_czas/10;
                    MessageBox.Show($"ilość dobrych ruchów:" + this.licznik_dobrych_ruchow + $"; skuteczność wyniosła:{(float)this.licznik1}%" +
                        $"; średni czas reakcji wyniósł:{czas1} sekundy");
                    this.OknoRodzic.label1.Text = this.licznik_dobrych_ruchow.ToString();
                    this.OknoRodzic.label2.Text = this.czas1.ToString();
                }
            }
        }
